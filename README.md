...
Machine readable schemas for the NAPLAN Online registration data set. Derived from the _NAPLAN Online Registration Data Set_ specification, v3.02 (March 2022)
...
* *Registration Data Set - Specifications v3.03.pdf* is the current registration data set specification.
